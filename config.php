...
// define('HOST','claradbp.database.windows.net');//claradbp.database.windows.net  service-claradb.database.windows.net
// define('DB', 'prospectos');//prospectos    prospectos-prod
// define('USERDB', 'prospectos');//adminserver    claradb-01
// define('PWDDB', 'Pr0sp3ct0S01');//U_p1ck_1T      Cl@r@-DB-01
// define('TYPE', 'sqlsrv');
