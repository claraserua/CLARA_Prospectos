...
$(document).ready(function(){
 ...
 function buscar()
 {
	...
	$.ajax({
		type: "GET",  
		url: "index.php",  
		data: "execute=preparatorias&method=Buscar"+urltag,  
 ...
 function AsignarPlanEstrategico(confirm){
  ...
  function AgregarNoticia(){
    ...
    type: "POST",  
    url: "index.php?execute=principal&method=Guardar",  
  ...
  function BuscarProspecto(idprospecto){  	
    ...
    type: "POST",  
    url: "index.php?execute=principal&method=BuscarProspecto",  
  ...
  function EditarProspecto(idprospecto){
    ...
    type: "POST",  
    url: "index.php?execute=principal&method=Editar",  
...
var arr = $("input:checked.usrcheck").getCheckboxValues();
 ...
 if(arr.length==0){
  ...
  function EliminarUsuario(confirm){
	...
	$.ajax({	 
    type: "POST",  
    url: "index.php?execute=principal&method=Eliminar",  
...
var arr = $("input:checked.usrcheck").getCheckboxValues();
 ...
 if(arr.length==0){
	alert("Debe marcar algun prospecto");
 }else{
	//alert(arr); // esto muestra un pop-up con los checkboxes seleccionados	
	 ...
	 setTimeout("window.location.href = '?execute=descargar_prospecto_prepa&usuarios="+usuarios+"'",0);
	...
	{*/
		...
		else
		{
		 ...
		 // alert(usuarios);
			...
			$.ajax({	 
		    type: "POST",  
		    url: "index.php?execute=principal&method=EnviarCorreoProsp",  
		    data: { usuarios:usuarios},
		    success: function(msg){				
