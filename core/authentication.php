...
class Authentication extends Session{
	...
	function  validarUsuario($user,$pass){
	        ...
	        $sql = "SELECT * FROM USUARIOS WHERE PK1= '$user' AND PASSWORD = '$pass'";
        ...
        $user = $_SESSION['session']['user'];
		$sql = "SELECT * FROM POPERATIVOS WHERE PK1 = '$plan' ";
		...
		function getPrivilegio($proyecto,$permiso){
		...
		$sql = "SELECT * FROM PROYECTOS_ASIGNACIONES WHERE PK_PROYECTO = '$proyecto' AND PK_USUARIO = '$user' ";	
		$row = database::getRow($sql);
