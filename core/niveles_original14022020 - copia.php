...
function initNivelesDocumentos($nivel = "0"){
    ...
    $$nodo = new HTML_TreeNodeXL(__toHtml($row['NOMBRE'], ENT_QUOTES, "ISO-8859-1"), "?execute=documentos/alumnos&Menu=F4&SubMenu=SF41&method=default&Nivel=".$row['PK1']."#&p=1&s=25&sort=1&q=", $this->nodeProperties); 
   ...
   foreach ($rows as $row) { 
    $i++;
	$subNode='subNode'.$i;
     $$subNode=&$nodo->addItem(new HTML_TreeNodeXL(__toHtml($row['NOMBRE'], ENT_QUOTES, "ISO-8859-1"), "?execute=documentos/alumnos&method=default&Menu=F4&SubMenu=SF41&Nivel=".$row['PK1']."#&p=1&s=25&sort=1&q=",
    $this->nodeProperties)); 
...
function initNivelesDocumentosEmpresas($nivel = "0"){
    ...
    $$nodo = new HTML_TreeNodeXL(__toHtml($row['NOMBRE'], ENT_QUOTES, "ISO-8859-1"), "?execute=documentos/organizaciones&Menu=F4&SubMenu=SF41&method=default&Nivel=".$row['PK1']."#&p=1&s=25&sort=1&q=", $this->nodeProperties); 
   ...
   foreach ($rows as $row) { 
    $i++;
	$subNode='subNode'.$i;
     $$subNode=&$nodo->addItem(new HTML_TreeNodeXL(__toHtml($row['NOMBRE'], ENT_QUOTES, "ISO-8859-1"), "?execute=documentos/organizaciones&method=default&Menu=F4&SubMenu=SF41&Nivel=".$row['PK1']."#&p=1&s=25&sort=1&q=",
    $this->nodeProperties)); 
    ...
    $$nodo = new HTML_TreeNodeXL(__toHtml($row['NOMBRE'], ENT_QUOTES, "ISO-8859-1"), "?execute=documentos/reportes&Menu=F4&SubMenu=SF41&method=default&Nivel=".$row['PK1']."#&p=1&s=25&sort=1&q=", $this->nodeProperties); 
   ...
   foreach ($rows as $row) { 
    $i++;
	$subNode='subNode'.$i;
     $$subNode=&$nodo->addItem(new HTML_TreeNodeXL(__toHtml($row['NOMBRE'], ENT_QUOTES, "ISO-8859-1"), "?execute=documentos/reportes&method=default&Menu=F4&SubMenu=SF41&Nivel=".$row['PK1']."#&p=1&s=25&sort=1&q=",
    $this->nodeProperties)); 
