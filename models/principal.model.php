...
FROM    ( SELECT ROW_NUMBER() OVER ( ORDER BY FECHA_R DESC ) AS RowNum, *
          FROM      PROSPECTOS WHERE PK_NIVEL = 2 AND PK_CAMPUS IN( $filter ) $order  $buscar
...
ORDER BY FECHA_R DESC";
		...
		$sqlcount = "SELECT * FROM PROSPECTOS WHERE PK_NIVEL = 2  AND PK_CAMPUS IN( $filter ) $order $buscar";
...
<table cellpadding="0" cellspacing="0" border="0" style="font-family:\'Segoe UI\', Tahoma, sans-serif; font-size:10pt; margin:0px;">
  ...
  <table cellpadding="0" cellspacing="0" border="0" width="100%" style="font-family:Segoe UI, Tahoma, sans-serif; font-size:10pt; color:#000;">
                <tr>
                  ...
                  <td style="padding:0px 15px; font-family:Segoe UI, Tahoma, sans-serif; font-size:10pt; color:#000;"><a href="http://redanahuac.mx/apreu/"  title="http://redanahuac.mx/apreu" style="color:#072b60;">http://redanahuac.mx/apreu/</a></td>
                </tr>
  </table>
