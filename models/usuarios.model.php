...
ORDER BY $order";
	...
	/*
		...
		*/
		 ...
		 $sqlcount = "SELECT * FROM USUARIOS WHERE PK_JERARQUIA IN( $filter ) $buscar";
	   ...
	   //CALCULAMOS EL TOTAL DE PAGINAS
		...
		$sql = "DELETE FROM USUARIOS WHERE PK1 = '$id' ";
		$result = database::executeQuery($sql);
		...
		$sql = "DELETE FROM ROLES_USUARIO WHERE PK_USUARIO = '$id'";
		$result = database::executeQuery($sql);
