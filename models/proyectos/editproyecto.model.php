	...
	/*	if(isset($_GET['idLineaE'])){
		...
		function getEstadoProyecto($id){
		    ...
		    switch(trim($row['ESTADO'])){
				...
				case "PA":
					$estado = '<span class="label label-warning">Propuesta</span> <span class="label label-info">ajustes</span>';	  	break;
...
ORDER BY $order";
	...
	if(isset($_POST['ftesInvExt_array'])){
		...
		$dinVPN = $_POST['dinVPN'];
		$vPN = $_POST['vPN'];
		$porcTIR = $_POST['porcTIR'];
		$tIR = $_POST['tIR'];
		$rBC = $_POST['rBC'];
		$dinPtoEqui = $_POST['dinPtoEqui'];
		$ptoEqui = $_POST['ptoEqui'];
		$porcROI = $_POST['porcROI'];
	    $rOI = $_POST['rOI'];
...
ORDER BY $order";
	...
	function Enviar($idProyecto,$estado1){
	$estado = trim($estado1);
	...
	if($estado1 == "E"){
		 ...
		 foreach(database::getRows($sql) as $row){ //while ($row =  mssql_fetch_array($result, MSSQL_ASSOC)) {
					 ...
					 if($passport->getPrivilegioRol($row['ROL'],'P341')){

								//   if($passport->getPrivilegioRol($row['ROL'],'P80')){
					$this->EnviarCorreoRevisionAjustada($_SESSION['session']['user'],$row['PK_USUARIO'],$idProyecto);
					                //}
...
$mail->Subject =  'Propuesta enviada para revisión preliminar';
...
<h1 style="font-family:Segoe UI, Tahoma, sans-serif; margin:0px; font-size:12pt; line-height:19px; color:#072B60; font-weight:normal;color:#ffffff;">Se ha enviado una propuesta para revisi&oacute;n preliminar.</h1>
...
<div style="margin-top:20px;font-family:\'Segoe UI\', Tahoma, sans-serif; font-size:10pt; line-height:13pt; color:#000;">
                  ...
                  <ul style="font-family:Segoe UI, Tahoma, sans-serif;color:#000;font-size:10pt;">
                    ...
                    <li>Puede comentar en cada rubro de la propuesta, agregar comentarios generales </li>



                   <li>S&oacute;lo los usuarios que tengan permiso podr&aacute;n enviar el proyecto para revisi&oacute;n.</li>
...
//}
 ...
 function EnviarCorreoRevisionAjustada($de,$para,$idProyecto){
...
$mail->Subject =  'Propuesta ajustada';
...
<h1 style="font-family:Segoe UI, Tahoma, sans-serif; margin:0px; font-size:12pt; line-height:19px; color:#072B60; font-weight:normal;color:#ffffff;">Se ha enviado una propuesta ajustada </h1>

<p style="margin:0;font-size:11pt;font-family:Segoe UI, Tahoma, sans-serif;color:#000;color:#ffffff;">Ahora puede ingresar y revisar los ajustes</p>
...
<div style="margin-top:20px;font-family:\'Segoe UI\', Tahoma, sans-serif; font-size:10pt; line-height:13pt; color:#000;">
                  ...
                  <ul style="font-family:Segoe UI, Tahoma, sans-serif;color:#000;font-size:10pt;">
                    ...
                    <li>Si la propuesta no ha sido correctamente ajustada, puede solicitar ajustes a la universidad.</li>              <li>Puede enviar la propuesta a los expertos si debe ser revisada nuevamente.</li>
                    <li>Si la propuesta ha sido ajustada correctamente y no necesita ser revisada por los expertos,  la propuesta se env&iacute;a revisada.</li>
