...
class revisionexProyectoModel {
 ...
 //para el id de inversion guardar en la tabla proyectos por si se guardaron datos vacios en PK_FINVERSION_INTERNA
	...
	function EnviarComentariosExpertos($idProyecto,$estado){
		...
		foreach(database::getRows($sql) as $row){
					 ...
					 if($passport->getPrivilegioRol($row['ROL'],'P307')){

								//   if($passport->getPrivilegioRol($row['ROL'],'P80')){
					$this->EnviarCorreoComentariosExpertos($_SESSION['session']['user'],$row['PK_USUARIO'],$idProyecto);
					                //}
	...
	function EnviarCorreoComentariosExpertos($de,$para,$idProyecto){
...
$mail->Subject = 'Propuesta comentada por expertos';
...
<p style="margin:0;font-size:11pt;font-family:Segoe UI, Tahoma, sans-serif;color:#000;color:#ffffff;">Puede ingresar y revisar los comentarios a la propuesta</p>
...
<img src="<?php $rutaActual;?>app/proyectos/skins/default/img/logo_anahuac.png"  alt="Red de Universidades Anahuac" border="0">
...
<p style="font-family:Segoe UI, Tahoma, sans-serif; font-size:10pt; color:#000;"> La propuesta: <strong>'.$proyecto.'</strong> ya ha sido revisada por el usuario: </p>
...
<table cellpadding="0" cellspacing="0" border="0" style="font-family:\'Segoe UI\', Tahoma, sans-serif; font-size:10pt; margin:0px;">
                ...
                <tr>
                               ...
                               <td><img src="<?php $rutaActual;?>app/proyectos/media/usuarios/'.$rowde['IMAGEN'].'" height="40"  widht="40" />  </td>
...
<div style="margin-top:20px;font-family:\'Segoe UI\', Tahoma, sans-serif; font-size:10pt; line-height:13pt; color:#000;">
                  ...
                  <li>Cada experto asignado revisar&aacute; la propuesta </li>
                    <li>Una vez realizada la revisi&oacute;n de todos los expertos, puede hacer los comentarios finales y enviar, si es necesario, la propuesta con petici&oacute;n de ajustes a la universidad.</li>
...
<br><p style="font-family:Segoe UI, Tahoma, sans-serif; font-size:10pt; color:#000;">Por favor vaya a la p&aacute;gina de inicio de sesi&oacute;n del Sistema de Gesti&oacute;n de Propuestas e ingrese con su usuario y contrase&ntilde;a:  </p>
  ...
  <table cellpadding="0" cellspacing="0" border="0" width="100%" style="font-family:Segoe UI, Tahoma, sans-serif; font-size:10pt; color:#000;">
                ...
                <tr>
                  ...
                  <td style="padding:0px 15px; font-family:Segoe UI, Tahoma, sans-serif; font-size:10pt; color:#000;"><a href="<?php $rutaActual;?>app/proyectos/"  title="<?php $rutaActual;?>app/proyectos/" style="color:#072b60;"><?php $rutaActual;?>app/proyectos/</a>.</td>
                               ...
                               <td width="585" valign="top" colspan="2" style="border-bottom:1px solid #e3e3e3; padding:20px 0;">
                                               ...
                                               <table cellpadding="0" cellspacing="0" border="0" width="585">
                                                               ...
                                                               <tr>
                                                                              ...
                                                                              <td width="127"><img src="<?php $rutaActual;?>portal/img/logo.png"  alt="Red de Universidades An&aacute;huac" border="0"></td>
...
//}
	...
	function EnviarRevisadoExpertos($idProyecto,$estado){
