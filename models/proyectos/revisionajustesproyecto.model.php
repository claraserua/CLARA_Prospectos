...
class revisionajustesProyectoModel {
...
ORDER BY $order";	
	...
	function EnviarConsultaExpertos($idProyecto,$estado){
		...
		foreach(database::getRows($sql) as $row){
					 ...
					 if($passport->getPrivilegioRol($row['ROL'],'P334')){
					              
								//   if($passport->getPrivilegioRol($row['ROL'],'P80')){ 	
					$this->EnviarCorreoExpertos($_SESSION['session']['user'],$row['PK_USUARIO'],$idProyecto);
					                //}
	...
	function EnviarCorreoExpertos($de,$para,$idProyecto){     
...
$mail->Subject = 'Propuesta enviada para su revisión por expertos';
...
<h1 style="font-family:Segoe UI, Tahoma, sans-serif; margin:0px; font-size:12pt; line-height:19px; color:#072B60; font-weight:normal;color:#ffffff;">Se ha enviado una propuesta para revisi&oacute;n por expertos</h1>

<p style="margin:0;font-size:11pt;font-family:Segoe UI, Tahoma, sans-serif;color:#000;color:#ffffff;">Puede ingresar y revisar la propuesta </p>
...
<p style="font-family:Segoe UI, Tahoma, sans-serif; font-size:10pt; color:#000;"> La propuesta: <strong>'.$proyecto.'</strong> ha sido enviada para su revisi&oacute;n por el usuario:  </p>
...
<div style="margin-top:20px;font-family:\'Segoe UI\', Tahoma, sans-serif; font-size:10pt; line-height:13pt; color:#000;">
                  ...
                  <ul style="font-family:Segoe UI, Tahoma, sans-serif;color:#000;font-size:10pt;">
                    ...
                    <li>puede comentar la propuesta por rubro.</li>
					<li>S&iacute; es necesario puede solicitar informaci&oacute;n adicional.</li>
					<li>Una vez terminada su revisi&oacute;n, debe enviar la propuesta con comentarios </li>

 

                    <!--<li>S&oacute;lo los usuarios que tengan permiso podr&aacute;n enviar el proyecto a revisado expertos.</li>-->
...
//}                          
	...
	function EnviarIntegrarPropuesta($idProyecto,$estado){
		...
		foreach(database::getRows($sql) as $row){
					 ...
					 if($passport->getPrivilegioRol($row['ROL'],'P320')){
					              
								//   if($passport->getPrivilegioRol($row['ROL'],'P80')){ 	
					$this->EnviarCorreoIntegrarPropuesta($_SESSION['session']['user'],$row['PK_USUARIO'],$idProyecto);
					                //}
	...
	function EnviarCorreoIntegrarPropuesta($de,$para,$idProyecto){     
...
$mail->Subject =  'Se ha enviado una propuesta revisada';
...
<h1 style="font-family:Segoe UI, Tahoma, sans-serif; margin:0px; font-size:12pt; line-height:19px; color:#072B60; font-weight:normal;color:#ffffff;">Se ha enviado una propuesta revisada por expertos</h1>
...
<p style="font-family:Segoe UI, Tahoma, sans-serif; font-size:10pt; color:#000;"> La propuesta: <strong>'.$proyecto.'</strong> ha sido enviada revisada por los expertos por el usuario:</p>
...
<div style="margin-top:20px;font-family:\'Segoe UI\', Tahoma, sans-serif; font-size:10pt; line-height:13pt; color:#000;">
                  ...
                  <ul style="font-family:Segoe UI, Tahoma, sans-serif;color:#000;font-size:10pt;">
                    ...
                    <li>La propuesta pasar&aacute; a ser integrada para su presentaci&oacute;n al Consejo Superior de la Red de Universidades An&aacute;huac.</li>
...
//}     
 ...
 function EnviarSolicitudAjustes($idProyecto,$estado){
		...
		foreach(database::getRows($sql) as $row){
					 ...
					 if($passport->getPrivilegioRol($row['ROL'],'P322')){
					           
								//   if($passport->getPrivilegioRol($row['ROL'],'P80')){ 	
					$this->EnviarCorreoSolicitudAjustes($_SESSION['session']['user'],$row['PK_USUARIO'],$idProyecto);                 
	...
	function EnviarCorreoSolicitudAjustes($de,$para,$idProyecto){     
...
<p style="font-family:Segoe UI, Tahoma, sans-serif; font-size:10pt; color:#000;"> La propuesta: <strong>'.$proyecto.'</strong>&nbsp;ha sido revisada por el usuario: </p>
