...
var s= parseInt(gup('s'));
  ...
  urltag = "&p="+gup('p')+"&s="+gup('s')+"&sort="+gup('sort')+"&q="+q;
   ...
   window.location.hash = urltag;
    ...
    type: "GET",  
    url: "index.php",  
    data: "execute=apoyos\\apoyos&method=Buscar"+urltag,  
...
function deleteEvidencia(id){
    ...
    type: "GET",  
    url: "index.php",  
    data: "execute=apoyos\\apoyos&method=Eliminar&idevidencia="+evidencia,  
    success: function(msg){  
...
function WindowOpen(id){
	    var href = "index.php?execute=apoyos/evidencia&method=default&id="+id;
