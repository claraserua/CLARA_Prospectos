...
if(confirm("¿Estás seguro que deseas  borrar el comentario?"))
{
	...
	$.ajax({
		type: "POST",
		url: "index.php?execute=proyectos/revisionexproyecto&method=eliminarComentario",  
...
if(confirm("¿Estás seguro que deseas  borrar el comentario?"))
{
	...
	$.ajax({
		type: "POST",
		url: "index.php?execute=proyectos/revisionexproyecto&method=eliminarComentarioGral",  
...
function guardarComentario(id,idProyecto, num){
	...
	$("#counter-"+id[1]).html('<img src="skins/default/img/spinner-mini.gif" />');
		...
		$.ajax({
			type: "POST",
			url: "index.php?execute=proyectos/revisionexproyecto&method=insertarComentario",  
...
function guardarComentarioGralProyecto(){
	...
	$("#counter-gralproyecto").html('<img src="skins/default/img/spinner-mini.gif" />');
		...
		$.ajax({
			type: "POST",
			url: "index.php?execute=proyectos/revisionexproyecto&method=insertarComentarioGral",  
 ...
 /*$('div.table').block({ css: { backgroundColor: 'transparent', color: '#EC5C00', border:"null" },
    ...
    type: "GET",  
    url: "index.php",  
    data: "execute=proyectos/revisionexproyecto&method=obtenerObjetivosE_Res&idLineaE="+idLineaE+"&idPlanO="+idPlanO,  
  ...
  function buscarArchivos(num){
   ...
   //alert(idProyecto+' buscar');
    ...
    type: "GET",  
    url: "index.php",  
    data: "execute=proyectos/revisionexproyecto&method=obtenerArchivo&num="+num+"&idProyecto="+idProyecto+"&editArchivo="+editArchivo,  
    success: function(msg){  
 ...
 // $.unblockUI();
  ...
  function deleteArchivo(id,num){
    ...
    type: "GET",  
    url: "index.php",  
    data: "execute=proyectos/revisionexproyecto&method=EliminarArchivo&idArchivo="+idArchivo+"&num="+num,  
    success: function(msg){  
...
function showLimitPage(s,id){
 ...
 /*$('div.tableModal').block({ css: { backgroundColor: 'transparent', color: '#EC5C00', border:"null" },
    ...
    type: "GET",  
    url: "index.php",  
    data: "execute=proyectos/revisionexproyecto&method=obtenerLineas&idplane="+idplane,  
    success: function(msg){  
 ...
 $('div.tableModal').block({ css: { backgroundColor: 'transparent', color: '#EC5C00', border:"null" },
  ...
  if(gup('filter')){
   ...
   window.location.hash = urltag;
    ...
    type: "GET",  
    url: "index.php",  
    data: "execute=proyectos/revisionexproyecto&method=BuscarPlanesOperativos&idplanE="+idplanE+""+urltag,  
    success: function(msg){  
	...
	switch(s)
{
 ...
 /*$('div.tableModal').block({ css: { backgroundColor: 'transparent', color: '#EC5C00', border:"null" },
    ...
    type: "GET",  
    url: "index.php",  
    data: "execute=proyectos/revisionexproyecto&method=obtenerResultados&idPlanO="+idPlanO,  
    success: function(msg){  
 ...
 function actualizaTextoCombosEstrategicos(){
  ...
  urltag = "&p="+gup('p')+"&s="+gup('s')+"&sort="+gup('sort')+"&q="+q;
   ...
   window.location.hash = urltag;
    ...
    type: "GET",  
    url: "index.php", 
    data: "execute=proyectos/revisionexproyecto&method=BuscarPlanesEstrategicos"+urltag,  
    success: function(msg){  
...
function GuardarProyecto(){
    ...
    type: "POST",  
    url: "index.php?execute=proyectos/revisionexproyecto&method=GuardarProyecto&Menu=F1&SubMenu=SF11",  
...
function EnviarComentariosExpertos(confirm){
    ...
    type: "GET",  
    url: "index.php",  
    data: "execute=proyectos/revisionexproyecto&method=EnviarComentariosExpertos&idProyecto="+idProyecto+'&estado='+estado,  
    success: function(msg){ 
	//alert(msg);
	
	 $.unblockUI();
	
	setTimeout("window.location.href = '?execute=principal&Menu=F1&SubMenu=SF11#&p=1&s=25&sort=1&q=&alert=3'",1000);
...
function EnviarRevisadoExpertos(confirm){
    ...
    type: "GET",  
    url: "index.php",  
    data: "execute=proyectos/revisionexproyecto&method=EnviarRevisadoExpertos&idProyecto="+idProyecto+'&estado='+estado,  
    success: function(msg){ 
	//alert(msg);
