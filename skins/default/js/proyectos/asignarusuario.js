...
// ----- FUNCION IMAGE PREVIEW USUARIOS--//
	...
	window.setTimeout("window.location.href='?execute=proyectos/asignaciones&method=null&Menu=F1&SubMenu=SF11&IDProyecto="+IDProyecto+"&IDJerarquia="+jerarquia+"#&p=1&s=25&sort=1&q=&alert=trueadduser'",700)
...
var s= parseInt(gup('s'));
  ...
  /*if(filter.length>0){
   ...
   window.location.hash = urltag;
    ...
    type: "GET",  
    url: "index.php",  
    data: "execute=proyectos/asignarusuario&method=Buscar"+urltag,  
