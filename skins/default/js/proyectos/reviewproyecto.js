...
if(confirm("¿Estás seguro que deseas  borrar el comentario?"))
{
	...
	$.ajax({
		type: "POST",
		url: "index.php?execute=proyectos/reviewproyecto&method=eliminarComentario",  
...
if(confirm("¿Estás seguro que deseas  borrar el comentario?"))
{
	...
	$.ajax({
		type: "POST",
		url: "index.php?execute=proyectos/reviewproyecto&method=eliminarComentarioGral",  
...
function guardarComentario(id,idProyecto, num){
	...
	$("#counter-"+id[1]).html('<img src="skins/default/img/spinner-mini.gif" />');
		...
		$.ajax({
			type: "POST",
			url: "index.php?execute=proyectos/reviewproyecto&method=insertarComentario",  
...
function guardarComentarioGralProyecto(){
	...
	$("#counter-gralproyecto").html('<img src="skins/default/img/spinner-mini.gif" />');
		...
		$.ajax({
			type: "POST",
			url: "index.php?execute=proyectos/reviewproyecto&method=insertarComentarioGral",  
 ...
 /*$('div.table').block({ css: { backgroundColor: 'transparent', color: '#EC5C00', border:"null" },
    ...
    type: "GET",  
    url: "index.php",  
    data: "execute=proyectos/reviewproyecto&method=obtenerObjetivosE_Res&idLineaE="+idLineaE+"&idPlanO="+idPlanO,  
  ...
  function buscarArchivos(num){
   ...
   //alert(idProyecto+' buscar');
    ...
    type: "GET",  
    url: "index.php",  
    data: "execute=proyectos/reviewproyecto&method=obtenerArchivo&num="+num+"&idProyecto="+idProyecto+"&editArchivo="+editArchivo,  
    success: function(msg){  
 ...
 // $.unblockUI();
  ...
  function deleteArchivo(id,num){
    ...
    type: "GET",  
    url: "index.php",  
    data: "execute=proyectos/reviewproyecto&method=EliminarArchivo&idArchivo="+idArchivo+"&num="+num,  
    success: function(msg){  
...
function showLimitPage(s,id){
 ...
 /*$('div.tableModal').block({ css: { backgroundColor: 'transparent', color: '#EC5C00', border:"null" },
    ...
    type: "GET",  
    url: "index.php",  
    data: "execute=proyectos/reviewproyecto&method=obtenerLineas&idplane="+idplane,  
    success: function(msg){  
 ...
 $('div.tableModal').block({ css: { backgroundColor: 'transparent', color: '#EC5C00', border:"null" },
  ...
  if(gup('filter')){
   ...
   window.location.hash = urltag;
    ...
    type: "GET",  
    url: "index.php",  
    data: "execute=proyectos/reviewproyecto&method=BuscarPlanesOperativos&idplanE="+idplanE+""+urltag,  
    success: function(msg){  
	...
	switch(s)
{
 ...
 /*$('div.tableModal').block({ css: { backgroundColor: 'transparent', color: '#EC5C00', border:"null" },
    ...
    type: "GET",  
    url: "index.php",  
    data: "execute=proyectos/reviewproyecto&method=obtenerResultados&idPlanO="+idPlanO,  
    success: function(msg){  
 ...
 function actualizaTextoCombosEstrategicos(){
  ...
  urltag = "&p="+gup('p')+"&s="+gup('s')+"&sort="+gup('sort')+"&q="+q;
   ...
   window.location.hash = urltag;
    ...
    type: "GET",  
    url: "index.php", 
    data: "execute=proyectos/reviewproyecto&method=BuscarPlanesEstrategicos"+urltag,  
    success: function(msg){  
...
function GuardarProyecto(){
    ...
    type: "POST",  
    url: "index.php?execute=proyectos/reviewproyecto&method=GuardarProyecto&Menu=F1&SubMenu=SF11",  
...
function RegresarPropUni(){
    ...
    type: "GET",  
    url: "index.php",  
    data: "execute=proyectos/reviewproyecto&method=RegresarPropUni&idProyecto="+idProyecto+'&estado='+estado,  
    success: function(msg){ 
...
function EnviarConRevisionPreliminar(confirm){
    ...
    type: "GET",  
    url: "index.php",  
    data: "execute=proyectos/reviewproyecto&method=EnviarConRevisionPreliminar&idProyecto="+idProyecto+'&estado='+estado,  
    success: function(msg){ 
	//alert(msg);
	
	 $.unblockUI();
	
	setTimeout("window.location.href = '?execute=principal&Menu=F1&SubMenu=SF11&alert=4#&p=1&s=25&sort=1&q=&alert=3'",1000);
