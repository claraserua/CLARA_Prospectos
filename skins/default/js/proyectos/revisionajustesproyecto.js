...
if(confirm("¿Estás seguro que deseas  borrar el comentario?"))
{
	...
	$.ajax({
		type: "POST",
		url: "index.php?execute=proyectos/revisionajustesproyecto&method=eliminarComentario",  
...
if(confirm("¿Estás seguro que deseas  borrar el comentario?"))
{
	...
	$.ajax({
		type: "POST",
		url: "index.php?execute=proyectos/revisionajustesproyecto&method=eliminarComentarioGral",  
...
function guardarComentario(id,idProyecto, num){
	...
	$("#counter-"+id[1]).html('<img src="skins/default/img/spinner-mini.gif" />');
		...
		$.ajax({
			type: "POST",
			url: "index.php?execute=proyectos/revisionajustesproyecto&method=insertarComentario",  
...
function guardarComentarioGralProyecto(){
	...
	$("#counter-gralproyecto").html('<img src="skins/default/img/spinner-mini.gif" />');
		...
		$.ajax({
			type: "POST",
			url: "index.php?execute=proyectos/revisionajustesproyecto&method=insertarComentarioGral",  
 ...
 /*$('div.table').block({ css: { backgroundColor: 'transparent', color: '#EC5C00', border:"null" },
    ...
    type: "GET",  
    url: "index.php",  
    data: "execute=proyectos/revisionajustesproyecto&method=obtenerObjetivosE_Res&idLineaE="+idLineaE+"&idPlanO="+idPlanO,  
  ...
  function buscarArchivos(num){
   ...
   //alert(idProyecto+' buscar');
    ...
    type: "GET",  
    url: "index.php",  
    data: "execute=proyectos/revisionajustesproyecto&method=obtenerArchivo&num="+num+"&idProyecto="+idProyecto+"&editArchivo="+editArchivo,  
    success: function(msg){  
 ...
 // $.unblockUI();
  ...
  function deleteArchivo(id,num){
    ...
    type: "GET",  
    url: "index.php",  
    data: "execute=proyectos/revisionajustesproyecto&method=EliminarArchivo&idArchivo="+idArchivo+"&num="+num,  
    success: function(msg){  
...
function showLimitPage(s,id){
 ...
 /*$('div.tableModal').block({ css: { backgroundColor: 'transparent', color: '#EC5C00', border:"null" },
    ...
    type: "GET",  
    url: "index.php",  
    data: "execute=proyectos/revisionajustesproyecto&method=obtenerLineas&idplane="+idplane,  
    success: function(msg){  
 ...
 $('div.tableModal').block({ css: { backgroundColor: 'transparent', color: '#EC5C00', border:"null" },
  ...
  if(gup('filter')){
   ...
   window.location.hash = urltag;
    ...
    type: "GET",  
    url: "index.php",  
    data: "execute=proyectos/revisionajustesproyecto&method=BuscarPlanesOperativos&idplanE="+idplanE+""+urltag,  
    success: function(msg){  
	...
	switch(s)
{
 ...
 /*$('div.tableModal').block({ css: { backgroundColor: 'transparent', color: '#EC5C00', border:"null" },
    ...
    type: "GET",  
    url: "index.php",  
    data: "execute=proyectos/revisionajustesproyecto&method=obtenerResultados&idPlanO="+idPlanO,  
    success: function(msg){  
 ...
 function actualizaTextoCombosEstrategicos(){
  ...
  urltag = "&p="+gup('p')+"&s="+gup('s')+"&sort="+gup('sort')+"&q="+q;
   ...
   window.location.hash = urltag;
    ...
    type: "GET",  
    url: "index.php", 
    data: "execute=proyectos/revisionajustesproyecto&method=BuscarPlanesEstrategicos"+urltag,  
    success: function(msg){  
...
function GuardarProyecto(){
    ...
    type: "POST",  
    url: "index.php?execute=proyectos/revisionajustesproyecto&method=GuardarProyecto&Menu=F1&SubMenu=SF11",  
...
function EnviarConsultaExpertos(){
    ...
    type: "GET",  
    url: "index.php",  
    data: "execute=proyectos/revisionajustesproyecto&method=EnviarConsultaExpertos&idProyecto="+idProyecto+'&estado='+estado,  
    success: function(msg){ 
	
	  $.unblockUI();
	  
	setTimeout("window.location.href = '?execute=principal&Menu=F1&SubMenu=SF11&alert=3#&p=1&s=25&sort=1&q='",1000);
...
function EnviarIntegrarPropuesta(){
    ...
    type: "GET",  
    url: "index.php",  
    data: "execute=proyectos/revisionajustesproyecto&method=EnviarIntegrarPropuesta&idProyecto="+idProyecto+'&estado='+estado,  
    success: function(msg){ 
	
	  $.unblockUI();
	  
	setTimeout("window.location.href = '?execute=principal&Menu=F1&SubMenu=SF11&alert=6#&p=1&s=25&sort=1&q='",1000);
...
function EnviarSolicitudAjustes(confirm){
		
	 	
	 /*if(!confirm){
	 //	alert('entro');
	 $('#titlemodal1').html('Enviar propuesta');
	 $('#bodymodal1').html('Se envia la popuesta con revisión preliminar');
	  $("#aceptarmodal1").attr("onClick", "javascript:EnviarConRevisionPreliminar(true);return false;");
    ...
    type: "GET",  
    url: "index.php",  
    data: "execute=proyectos/revisionajustesproyecto&method=EnviarSolicitudAjustes&idProyecto="+idProyecto+'&estado='+estado,  
    success: function(msg){ 
	//alert(msg);
	
	 $.unblockUI();
	
	setTimeout("window.location.href = '?execute=principal&Menu=F1&SubMenu=SF11&alert=5#&p=1&s=25&sort=1&q='",1000);
	/*setTimeout("window.location.href = '?execute=proyectos/editproyecto&method=default&Menu=F1&SubMenu=SF11&IDProyecto="+idProyecto+"'",1000);*/
