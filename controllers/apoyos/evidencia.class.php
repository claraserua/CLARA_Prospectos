<?php
include "models/apoyos/evidencia.model.php";
...
class evidencia {
	...
	function viewRecurso(){
		...
		$imagen  = $row['IMAGEN'];
		$adjunto = $row['ADJUNTO'];
		$preview = "<img src='media/apoyos/thum_340x220_".$imagen."'/>";
		$autor = $row['AUTOR'];
		$formato = "";
...
WIDTH="340" HEIGHT="220" ShowControls="1" ShowStatusBar="0" ShowDisplay="0" autostart="0"> </EMBED>
	  ...
	  case "TXT":
	   ...
	   /* if(!$this->passport->getPrivilegio($_GET['IDPlan'],'P34')){
		...
		$this->View->template = TEMPLATE.'modules/apoyos/EVIDENCIA.TPL';
		...
		$this->View->replace_content('/\#DESCRIPCION\#/ms' ,__toHtml($descripcion));	
