...
class editroles{
	...
	function __construct() {
	 ...
	 function loadContent(){
		...
		$contenido = $this->View->replace('/\#NOMBRE\#/ms' ,__toHtml($row['ROLE'], ENT_QUOTES, "ISO-8859-1"),$contenido);
		...
		if(trim($row['TIPO'])=="A"){
		$contenido =  $this->View->replace('/\#ASIGNACIONA\#/ms' ,'checked="checked"',$contenido);
		}
		else{
