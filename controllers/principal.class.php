...
class principal {	
	...
	{
		$section = TEMPLATE.'modules/noticias/GRDNOTICIAS.TPL';
		$section = $this->View->loadSection($section);
	...
	//	$total = $this->Model->totalnum;
		...
		if($numrecursos != 0){
			 ...
			 $recurso.='<tr>';		 	  
			  ...
			  $recurso.='<th style="border:1px #999999 solid; background:#FF4712; color:#FFF;">Periodo</th>';
...
$recurso .= '<tr>
				...
				<td style="border:1px #999999 solid; font-size:12px;">'.$row['PERIODO'].'</td>
				...
				$recurso .='
					<li>
						<table><tbody><tr>
							...
							<td>
								<div class="comment-info-20">
									<h3><b>Nombre:   </b>'.__toHtml($row['NOMBRE'], ENT_QUOTES, "ISO-8859-1").' '.utf8_encode($row['APELLIDOS']).' &nbsp;&nbsp;
										<b>Programa: </b>'.__toHtml($row['PROGRAMA'], ENT_QUOTES, "ISO-8859-1").' &nbsp;&nbsp;
										<b>Campus:   </b>'.$row['PK_CAMPUS'].'&nbsp;&nbsp;
										<b>Periodo:   </b>'.$row['PERIODO'].'
									</h3>
	...
	#---------------------PAGINADO---------------------------#
	 ...
	 <div class="bar_seperator"></div>
	   ...
	   <div id="results_text">
	     ...
	     <div style="position:relative; top:0px; left:10px;"> <b>Seleccionar todos</b>&nbsp;<input type="checkbox" id="checkboxall1c" onClick="seleccionarTodo(\'1c\')" name="checkboxall"/></div>
