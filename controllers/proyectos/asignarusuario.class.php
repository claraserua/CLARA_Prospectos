<?php
include "models/proyectos/asignarusuario.model.php";
...
class asignarusuario {
	...
	function error(){
	 ...
	 function loadContent(){
		...
		$contenido = $this->View->Template(TEMPLATE.'modules/proyecto/ASIGNARUSUARIO.TPL');
		
		
	  $url = "?execute=proyectos/asignaciones&method=default&Menu=F1&SubMenu=SF11&IDProyecto=".$_GET['IDProyecto']."&IDJerarquia=".$_GET['IDJerarquia']."#&p=1&s=25&sort=1&q=";
		...
		$contenido =  $this->View->replace('/\#IDPROYECTO\#/ms' ,$_GET['IDProyecto'],$contenido);
		...
		$this->View->replace_content('/\#CONTENT\#/ms' ,$contenido);
         ...
         function GuardarUsuario(){
			...
			$this->Model->proyecto = $_POST['idProyecto'];
