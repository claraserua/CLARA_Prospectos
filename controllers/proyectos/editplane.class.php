...
class editplane {
	...
	function error(){
	 ...
	 function loadContent(){
		...
		$section = $this->View->replace('/\#DESCRIPCION\#/ms',__toHtml($row['DESCRIPCION'], ENT_QUOTES, "ISO-8859-1"),$section);
		$section = $this->View->replace('/\#FECHA_I\#/ms' ,$row['FECHA_I'],$section);
		$section = $this->View->replace('/\#FECHA_T\#/ms' ,$row['FECHA_T'],$section);
