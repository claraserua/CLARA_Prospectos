<?php
include "models/jerarquia/movejerarquia.model.php";
...
class movejerarquia {
	...
	function __construct() {
	 ...
	 $this->menu = new Menu();
	 $this->nodoprincipal = new Niveles("move");
	 $this->Model = new movejerarquiaModel();
	...
	function error(){
	 ...
	 function loadContent(){
		...
		$contenido = $this->View->Template(TEMPLATE.'modules/jerarquia/MOVEJERARQUIA.TPL');
		$urlbtncancelar = "?execute=jerarquia&method=default&Menu=F3&SubMenu=SF34&Nivel=".$_GET['Padre']."#&p=1&s=25&sort=1&q=";
		$urlformaction = "?execute=jerarquia&method=Mover&Menu=F3&SubMenu=SF34&Nivel=".$_GET['Padre']."#&p=1&s=25&sort=1&q=";
		...
		$contenido =  $this->View->replace('/\#NODOS\#/ms' ,$this->nodoprincipal->nodos,$contenido);
