	...
	var Chart = function(div, opts) {
        ...
        function addVtHeader(div, data, cellHeight) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                }).append('<span>'+data[i].name+'</span><img width="16" height="16" style="cursor:pointer; display:none;" onclick="removeEtapa('+data[i].id+');" class="icongantt" src="libs/gantt/img/delete.gif"><img width="16" height="16" style="cursor:pointer; display:none;" onclick="editEtapa('+data[i].id+',\''+data[i].name+'\');" class="icongantt" src="libs/gantt/img/pencil.png">'));
                var seriesDiv = jQuery("<div>", { "class": "ganttview-vtheader-series", "id": "etapaseries"+data[i].id });
                for (var j = 0; j < data[i].series.length; j++) {
                    seriesDiv.append(jQuery("<div>", { "class": "ganttview-vtheader-series-name","id": "P"+data[i].series[j].id})
						.append('<span>'+data[i].series[j].name+'</span><img width="16" height="16" style="cursor:pointer; display:none;" onclick="removePaso('+data[i].series[j].id+');" class="icongantt" src="libs/gantt/img/delete.gif"><img width="16" height="16" style="cursor:pointer; display:none;" onclick="editPaso('+data[i].series[j].id+',\''+data[i].series[j].name+'\',\''+data[i].series[j].start+'\',\''+data[i].series[j].end+'\');" class="icongantt" src="libs/gantt/img/pencil.png">'));
                }
        ...
        function addBlockContainers(div, data) {
            ...
            for (var i = 0; i < data.length; i++) {
				...
				block = jQuery("<div>", { "id": "block"+data[i].id });
				blocksDiv.append(block);
                
				for (var j = 0; j < data[i].series.length; j++) {
                    block.append(jQuery("<div>", { "class": "ganttview-block-container", "id": "G"+data[i].series[j].id }));
