...
function getUniversidadesPos(){
		...
		$scopeform.ajax({ 	 	 
			url: "http://redanahuac.mx/app/prospectos/testformapreu.php?method=getUniversidadesPos",
			dataType: 'jsonp',
			jsonp: 'callback',
			contentType: "application/json; charset=utf-8",	
			data: { nivel:nivel},  
...
function getProgramsPos()
{
		...
		//  $scopeform("#campusrua854").html('<option value="NONE">Campus de Inter&eacute;s...</option>');
		  ...
		  // alert('programu');
		$scopeform.ajax({ 	 	 
        url: "http://redanahuac.mx/app/prospectos/testformapreu.php?method=getProgramsPos",
        dataType: 'jsonp',
		jsonp: 'callback',
        contentType: "application/json; charset=utf-8",	
...
function getPrograms()
{
		  ...
		  // alert('programu');
		$scopeform.ajax({ 	 	 
        url: "http://redanahuac.mx/app/prospectos/testformapreu.php?method=getPrograms",
        dataType: 'jsonp',
		jsonp: 'callback',
        contentType: "application/json; charset=utf-8",	
        data: { nivel:nivel},  
...
function getUniversidades(){
	...
	if(programa=='NONE' /*|| (nivel != 2 && nivel !=4 && nivel !=5 && nivel !=6 )*/){//cambio
		...
		$scopeform.ajax({ 	 	 
			url: "http://redanahuac.mx/app/prospectos/testformapreu.php?method=getUniversidades",
			dataType: 'jsonp',
			jsonp: 'callback',
			contentType: "application/json; charset=utf-8",	
...
{
	$scopeform.ajax({
		url: 'http://redanahuac.mx/app/prospectos/testformapreu.php?method=getEstados',
		dataType: 'jsonp',
		jsonp: 'callback',
		contentType: 'application/json; charset=utf-8',
		data: {},
...
function getMunicipios()
{
	...
	$scopeform.ajax({
		url: 'http://redanahuac.mx/app/prospectos/testformapreu.php?method=getMunicipios&estado=' + estado,
		dataType: 'jsonp',
		jsonp: 'callback',
		contentType: "application/json; charset=utf-8",
		data: {},
...
function sendMessage457(){
	...
	var url_webservice = 'http://redanahuac.mx/app/prospectos/testformapreu.php?method=Guardar';
	buttonSend_Sending();
