...
if (xhrUNO.readyState == 4 && xhrUNO.status == 200) {
		...
		es_produccion = inArray(window.location.host,response); 
		 ...
		 if (es_pruebas)
			...
			__dominio =        'https://testprospectos.redanahuac.mxx';
			__url_home =        'https://testprospectos.redanahuac.mx';
			__url_aviso_prepa = 'https://testprospectos.redanahuac.mx/prepa/gracias';
...
xhrDOS.open('GET', "https://prospectos.redanahuac.mx/checadominiopruebas.php", true);
xhrDOS.send();
