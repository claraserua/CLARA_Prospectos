	...
	var __webservice_php = 'http://13.84.158.61/app/prospectos/testformapreu.php';
...
function insertForm(){
      ...
      var htmlfrmcontact = '<div class="rowk4">';
         ...
         /* htmlfrmcontact += '<div class="input-field colk4 s12">';
          ...
          htmlfrmcontact += '<a href="javascript:poponloadAviso()" class="aviso">Aviso de privacidad oo</a>';
          htmlfrmcontact += '</div>';
...
function getPrograms()
{
		  ...
		  $scopeform("#campusrua854").html('<option value="NONE">Campus de Inter&eacute;s...</option>');
		   ...
		   if((nivel=='NONE' || nivel==8)){//2do cambio 
