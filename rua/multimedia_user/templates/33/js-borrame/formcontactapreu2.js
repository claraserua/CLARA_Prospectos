	...
	// var __webservice_php = 'https://redanahuac.mx/app/prospectos/formapreu2.php';
	// var __dominio =        'https://redanahuac.mx';

	var __webservice_php = 'https://prospectos.redanahuac.mx/formapreu2.php';
	var __dominio =        'https://prospectos.redanahuac.mx';
	
	//var __webservice_php = 'http://13.84.158.61/app/prospectos/formapreu2.php';
	//var __dominio =        'http://13.84.158.61';
...
function InitForm(){
      ...
      $scopeform('head').append('<link rel="stylesheet" href="' + __dominio + '/app/prospectos/views/apreu/css/formcontactapreu.css" type="text/css" />');
...
function insertForm(){
      ...
      var htmlfrmcontact = '<div class="rowk4">';
		  ...
		  // NOMBRE
          htmlfrmcontact += '<div class="input-field colk4 s12">';
          htmlfrmcontact += '<img src="' + __dominio + '/app/prospectos/views/apreu/imagenes/user.png" class="imgapreu" />';
         ...
         /* htmlfrmcontact += '<div class="input-field colk4 s12">';
		  ...
		  // CORREO
          htmlfrmcontact += '<div class="input-field colk4 s12">';
          htmlfrmcontact += '<img src="' + __dominio + '/app/prospectos/views/apreu/imagenes/correo.png" class="imgapreu" />';
          ...
          // TELEFONO
          htmlfrmcontact += '<div class="input-field colk4 s12">';
          htmlfrmcontact += '<img src="' + __dominio + '/app/prospectos/views/apreu/imagenes/phone.png" class="imgapreu" />';
...
function sendMessage457(){
	...
	}else{modalrua.style.display = "block";}
