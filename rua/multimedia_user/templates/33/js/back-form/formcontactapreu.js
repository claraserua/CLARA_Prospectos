  ...
  */
    ...
    //var __webservice_php = 'http://13.65.208.28/app/prospectos/formapreu_vdelacruz.php';
    var __webservice_php = 'ttps://testprospectos.redanahuac.mx/testformapreu_crm_vdelacruz.php';
	var __webservice_php_leads = 'https://leads-redanahuac.mx/api/leads';
//    var __webservice_php = 'http://13.65.208.28/app/prospectos/testformapreu_crm_vdelacruz.php';

	// var __dominio =        'https://redanahuac.mx';
	var __dominio =        'https://testprospectos.redanahuac.mx';
	var __url_aviso_prepa = 'http://anahuac.mx/prepa/gracias';
...
if(month>=7)
{
 ...
 htmlfrmcontact +='<option value="'+ (year + 2) +'60">Agosto - ' + (year + 2) +'</option>';
	htmlfrmcontact +='<option value="'+ (year + 3) +'10">Enero - ' + (year + 3) +'</option>';
        ...
        // htmlfrmcontact += '<input id="nombre457" class="inputformapreu" type="text" placeholder="Nombre_P" onclick="resetTimer()" onkeydown="resetTimer()" onchange="resetTimer()"><i id="nombre_asterisco" style="font-size:13pt;color:red">*</i></input>';
          htmlfrmcontact += '</div>';
...
/*
		  ...
		  htmlfrmcontact += '<option value="Masculino" >Masculino</option>';
		  htmlfrmcontact += '<option value="Femenino" >Femenino</option>';
          htmlfrmcontact += '</select>';
		 // FECHA DE NACIMIENTO
          htmlfrmcontact += '<div class="input-field colk4 s12">';
          htmlfrmcontact += '<img src="' + __dominio + '/app/prospectos/views/apreu/imagenes/Icono-persona.png" class="imgapreu" />';
		  ...
		  htmlfrmcontact += '<p class="inputformapreu">Fecha Nacimiento: <input type="text" id="datepicker" style="margin-left: 3.3em!important;"></p>';
