...
function getNiveles()
{
	...
	$scopeform.ajax({ 	 	 
		url: "http://redanahuac.mx/app/prospectos/pruebaformapreu.php?method=getNiveles",
		dataType: 'jsonp',
		jsonp: 'callback',
...
function getPrograms()
{
	    ...
	    //  $scopeform("#campusruaTol").html('');
		  ...
		  // alert('programu');
		$scopeform.ajax({ 	 	 
        url: "http://redanahuac.mx/app/prospectos/pruebaformapreu.php?method=getPrograms",
        dataType: 'jsonp',
		jsonp: 'callback',
        contentType: "application/json; charset=utf-8",	
        data: { nivel:nivel},  
...
function getUniversidades(){
	...
	if(programa=='NONE' /*|| (nivel != 2 && nivel !=4 && nivel !=5 && nivel !=6 )*/){//cambio
		...
		$scopeform.ajax({ 	 	 
			url: "http://redanahuac.mx/app/prospectos/pruebaformapreu.php?method=getUniversidades",
			dataType: 'jsonp',
			jsonp: 'callback',
			contentType: "application/json; charset=utf-8",	
...
{
	$scopeform.ajax({
		url: 'http://redanahuac.mx/app/prospectos/pruebaformapreu.php?method=getEstados',
		dataType: 'jsonp',
		jsonp: 'callback',
		contentType: 'application/json; charset=utf-8',
		data: {},
...
function getMunicipios()
{
	...
	$scopeform.ajax({
		url: 'http://redanahuac.mx/app/prospectos/pruebaformapreu.php?method=getMunicipios&estado=' + estado,
		dataType: 'jsonp',
		jsonp: 'callback',
		contentType: "application/json; charset=utf-8",
		data: {},
...
function sendMessage457(){
	...
	var telefono = $scopeform('#telefono454').val();
	...
	var url_webservice = 'http://redanahuac.mx/app/prospectos/pruebaformapreu.php?method=Guardar';
	buttonSend_Sending();
